...
const ELEMENT_EMOJI = { '목': '木', '화': '火', '토': '土', '금': '金', '수': '水' };
...
function getTodayFoods(weakEl, strongEl, rel) {
  ...
  const foods = {
    '목': [
      ...
      { emoji:'🥑', name:'아보카도', reason:'불포화지방산이 간 건강을 지키고 목 기운을 보충합니다' }
    ],
    '화': [
      ...
      { emoji:'🥕', name:'당근', reason:'베타카로틴이 혈관을 보호하고 화 기운을 따뜻하게 합니다' }
    ],
    '토': [
      ...
      { emoji:'🌽', name:'옥수수', reason:'소화 기능을 돕고 비위를 강화하여 토 기운을 채웁니다' }
    ],
    '금': [
      ...
      { emoji:'🧄', name:'생강', reason:'폐를 따뜻하게 하고 기관지 면역력을 높여줍니다' }
    ],
    '수': [
      ...
      { emoji:'🥒', name:'오이', reason:'수분 공급과 이뇨 작용으로 수 기운 순환을 돕습니다' }
    ]
  };
